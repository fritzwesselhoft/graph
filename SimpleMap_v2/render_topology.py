        ...
        with Cluster("AgentCore"):
            ...
            with Cluster("Control Path"):
                for n in connected_nodes:
                    if n["type"] in ("policy_engine", "gateway", "gateway_target"):
                        rendered[n["id"]] = make_node(n)

            # Unlinked but still owned by AgentCore
            inventory_rendered = []
            if unlinked_nodes:
                ...
                # Keep unlinked resources together horizontally
